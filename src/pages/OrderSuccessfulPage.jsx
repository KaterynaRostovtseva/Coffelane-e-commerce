...
import { clearCurrentOrder } from "../store/slice/ordersSlice.jsx";
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Button
                    onClick={() => navigate('/account/orders-history', { state: { openOrderId: orderId } })}
                    sx={{
                        ...btnStyles,
                        textTransform: 'none',
                        width: { xs: '100%', sm: 'auto' },
